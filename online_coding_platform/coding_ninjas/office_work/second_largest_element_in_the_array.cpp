...
1 <= T <= 100
1 <= N <= 5000
-10 ^ 9 <= 'SIZE' <= 10 ^ 9 Where ‘T’ is the total number of test cases, ‘N’ denotes the number of elements in the array and ‘SIZE’ denotes the range of the elements in the array.
Time limit: 1 sec.
...
int main()
{
     ...
     int seclar = findSecondLargest(n, v);
     cout << "    Second Largest Element in Vector:- " << seclar << endl;
